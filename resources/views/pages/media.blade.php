            ...
            <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
              ...
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">Images</span>
                </a>
              </div>
              <!--end:Item-->
              ...
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">Documents</span>
                  <span class="navi-label">
              ...
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">Vidéo</span>
                </a>
              </div>
              <!--end:Item-->
              ...
              <div class="navi-item my-2">
                <a href="#" class="navi-link">
                  ...
                  <span class="navi-text font-weight-bolder font-size-lg">Total</span>
                </a>
              </div>
              <!--end:Item-->
            </div>
          ...
          <div class="card card-custom gutter-b">
            ...
            <div class="card-body d-flex align-items-center justify-content-between flex-wrap py-3">
              ...
              <div class="d-flex align-items-center mr-2 py-2">
                <!--begin::Title-->
                <h3 class="font-weight-bold mb-0 mr-10">Listing medias</h3>
                <!--end::Title-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center">
                    <!--begin: Icon-->
                    <img alt="" class="max-h-65px" src="{{ asset('media/svg/files/doc.svg') }}" />
                    <!--end: Icon-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center">
                    <!--begin: Icon-->
                    <img alt="" class="max-h-65px" src="{{ asset('media/svg/files/xml.svg') }}" />
                    <!--end: Icon-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center">
                    <!--begin: Icon-->
                    <img alt="" class="max-h-65px" src="{{ asset('media/svg/files/html.svg') }}" />
                    <!--end: Icon-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center">
                    <!--begin: Icon-->
                    <img alt="" class="max-h-65px" src="{{ asset('media/svg/files/csv.svg') }}" />
                    <!--end: Icon-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center">
                    <!--begin: Icon-->
                    <img alt="" class="max-h-65px" src="{{ asset('media/svg/files/zip.svg') }}" />
                    <!--end: Icon-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center">
                    <!--begin: Icon-->
                    <img alt="" class="max-h-65px" src="{{ asset('media/svg/files/jpg.svg') }}" />
                    <!--end: Icon-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center">
                    <!--begin: Icon-->
                    <img alt="" class="max-h-65px" src="{{ asset('media/svg/files/mp4.svg') }}" />
                    <!--end: Icon-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center">
                    <!--begin: Icon-->
                    <img alt="" class="max-h-65px" src="{{ asset('media/svg/files/javascript.svg') }}" />
                    <!--end: Icon-->
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
              ...
              <div class="card card-custom gutter-b card-stretch">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center">
                    <!--begin: Icon-->
                    <img alt="" class="h-65px" src="{{ asset('media/svg/icons/files/Uploaded') }}-file.svg" />
                    <!--end: Icon-->
